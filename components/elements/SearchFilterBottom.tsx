...
export default function SearchFilterBottom({ miniField }: SearchFilterBottomProps) {
	const { handleSearchChange, filter, handleClearFilters } = useTourContext()
			...
			<div className="box-bottom-search background-card">
				{!miniField &&
					<div className="item-search">
						<label className="text-sm-bold neutral-500">Search</label>
				...
				<div className="item-search bd-none d-flex justify-content-end">
					<button className="btn btn-black-lg" onClick={handleSubmit}>
